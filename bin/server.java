...
public class server {
	...
	static final Path FOLDER = Paths.get(Paths.get("").toAbsolutePath() + "/server_fl");
	...
	public static void main(String[] args) throws IOException
	{
		if (args.length != 2)
		{
			System.out.println("Usage: java server.java <server port> <tcp/udp>");
			System.exit(0);
		}
	...
	/**
	 * Sends a file to the cache via TCP
	 * @param cmd
	 * @throws IOException
	 */
	public static void putTCP(String cmd) throws IOException
	{
		// cmd.substring(4) takes the name of the file to be sent
	...
	/**
	 * Receives a file from the client using TCP
	 * @param cmd
	 * @throws IOException
	 */
	...
	/**
	 * Sends a file to the cache using UDP SNW
	 * @param cmd
	 * @throws IOException
	 */
	...
	/**
	 * Receives a file from client using UDP SNW
	 * @param cmd
	 * @throws IOException
	 */
